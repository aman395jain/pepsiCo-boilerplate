                                ...
                                <div className="media rack-content" style={{ paddingRight: "0" }}>
                                    ...
                                    <div className="media-body">
                                        <div className="content-center">
                                            ...
                                            <i class="fa fa-trash fa-lg icon-pos" style={{ right: "20px", zIndex: -2000 }} aria-hidden="true"></i>
...
export default RemoveAssociatedRacks;